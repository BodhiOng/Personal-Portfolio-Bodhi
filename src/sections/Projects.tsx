...
const projectsData: Project[] = [
    ...
    },
    {
        ...
        technologies: ['Flutter', 'Dart', 'Firebase'],
        github: 'https://github.com/BodhiOng/CommunityShare-Final-Year-Project',
    ...
    },
    {
        ...
        github: 'https://github.com/BodhiOng/Gamesphere-Tournament-Hub',
            ...
            <div className="mx-auto max-w-6xl relative z-10">
                ...
                <div className="mb-10 hidden flex-col gap-4 md:flex lg:flex-row lg:items-end lg:justify-between">
                    ...
                    <div className="flex items-center gap-3 self-start lg:self-auto">
                        <button
                            ...
                            className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-blue-300/25 bg-blue-300/5 text-white transition-colors duration-300 hover:bg-blue-300/10"
                        >
                ...
                <div className="grid gap-6 md:hidden">
                    {projectsData.map((project, index) => (
                        <article
                            key={index}
                            className="overflow-hidden rounded-[1.75rem] border border-blue-300/25 bg-slate-950/70 shadow-xl shadow-slate-950/30 ring-1 ring-white/10 backdrop-blur-md"
                        >
                            <div className="relative h-48 w-full overflow-hidden border-b border-blue-300/20 bg-slate-900">
                                <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/0 via-black/0 to-black/55"></div>
                                {project.image ? (
                                    <img
                                        src={project.image}
                                        alt={project.title}
                                ...
                                <div className="flex flex-wrap gap-3 pt-1">
                                    {project.github && (
                                        <a
                                            ...
                                            className="inline-flex items-center gap-2 rounded-xl border border-blue-300/25 bg-blue-300/5 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:bg-blue-300/10"
                                        >
                ...
                <div ref={trackRef} className="hidden flex gap-6 overflow-x-hidden pb-6 snap-x snap-mandatory scroll-smooth -mx-6 px-6 md:flex md:px-0">
                    {projectsData.map((project, index) => (
                        <div
                            key={index}
                            data-project-card
                            className="snap-start flex-none w-[92%] sm:w-[calc(50%-0.75rem)] lg:w-[calc(50%-0.75rem)] group min-h-[620px] sm:min-h-[660px] overflow-hidden rounded-[1.75rem] border border-blue-300/25 bg-slate-950/70 shadow-xl shadow-slate-950/30 ring-1 ring-white/10 transition-all duration-300 hover:-translate-y-1 hover:border-blue-200/45 hover:ring-blue-300/20 hover:shadow-2xl hover:shadow-slate-950/40 backdrop-blur-md"
                        >
                            <div className="flex flex-col h-full">
                                <div className="relative h-64 w-full overflow-hidden border-b border-blue-300/20 bg-slate-900 md:h-72">
                                    <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/0 via-black/0 to-black/55"></div>
                                    {project.image ? (
                                        <img
                                            src={project.image}
                                    ...
                                    {project.image && (
                                        <div className="absolute bottom-0 left-0 right-0 z-20 px-6 pb-4 pt-8">
