...
const AboutMe = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6 select-none relative">
            ...
            >
                <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 mb-8 pb-3 inline-block">
                    About Me
                </h1>
